...
void loop(){
  analogWrite(LED, helligkeit);  // Mit der Funktion analogWrite wird hier an dem Pin mit der LED (Pin9) die PWM Ausgabe aktiviert.
                                 // Der PWM-Wert ist der Wert, der unter dem Namen „helligkeit“ gespeichert ist. In diesem Fall „0“ (Siehe ersten Programmabschnitt)
                                
  helligkeit = helligkeit + fadeschritte;  // Nun wird der Wert für die PWM-Ausgabe verändert.
                                           // Unter dem Wert „helligkeit“ wird jetzt zur vorherigen helligkeit der Wert für die fadeschritte addiert.
  ...
  if (helligkeit == 0 || helligkeit == 255)  // Bedeutung des Befehls: Wenn die Helligkeit den Wert 0 ODER 255 erreicht hat,
                                             // wechselt der Wert für die „fadeschritte“ von positiv zu negativ bzw. andersrum.
                                             // Grund: Die LED wird zunächst bei jedem Durchlauf des Loop-Teils immer ein bisschen heller.
                                             ...
                                             // Also wird der Wert für die „fadeschritte“ an dieser Stelle negativiert (Ein Minuszeichen wird davor gesetzt).
    {
    fadeschritte = -fadeschritte ;  // Das bedeutet für den nächsten Durchlauf,
                                    ...
                                    // Im nächsten Durchlauf 245 usw. usw… Sobald der Wert für Helligkeit bei 0 angekommen ist,
                                    // wechselt wieder das Vorzeichen.
